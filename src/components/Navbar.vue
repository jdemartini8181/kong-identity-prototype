  ...
  <header class="kong-ui-app-navbar" data-testid="kong-ui-app-navbar">
    ...
    <div class="navbar-logo-container">
      ...
      <button class="org-menu" type="button" aria-label="Organization">
        ...
        <span class="org-name">Kong Design</span>
    ...
    <div class="navbar-controls-container">
      <button class="ask-kai-btn" type="button" aria-label="Ask KAi">
        <svg class="ask-kai-icon" fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.3337 8.05814V8.28545C10.4755 8.28545 9.70686 10.7705 9.70686 12.798H9.48227C9.48227 10.7705 8.58245 8.28545 5.85547 8.28545V8.05814C8.99831 8.05814 9.48227 5.57309 9.48227 3.54561H9.70686C9.70686 5.57309 10.1988 8.05814 13.3337 8.05814ZM4.85785 7.36886C4.85785 6.21543 5.29544 4.80169 6.9212 4.80169V4.67264C5.1375 4.67264 4.85785 3.2589 4.85785 2.10547H4.73034C4.73034 3.2589 4.45503 4.67264 2.66699 4.67264V4.80169C4.21885 4.80169 4.73034 6.21543 4.73034 7.36886H4.85785ZM6.14092 9.41028H6.03225C6.03225 10.3929 5.79751 11.5976 4.27391 11.5976V11.7076C5.59611 11.7076 6.03225 12.9124 6.03225 13.8949H6.14092C6.14092 12.9124 6.51331 11.7076 7.89926 11.7076V11.5976C6.37928 11.5976 6.14092 10.3929 6.14092 9.41028Z" fill="url(#kai-sparkle-gradient)" />
          <defs>
            <linearGradient id="kai-sparkle-gradient" gradientUnits="userSpaceOnUse" x1="2.62219" x2="12.6125" y1="13.8949" y2="1.48866">
