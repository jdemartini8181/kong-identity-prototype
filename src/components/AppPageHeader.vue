  ...
  <div class="kong-ui-app-page-header">
    ...
    >
      <KBreadcrumbs
        ...
        :items="breadcrumbs"
      >
        <template v-for="slotName in breadcrumbIconSlots" :key="slotName" #[slotName]>
          <slot :name="slotName" />
        </template>
      </KBreadcrumbs>
    </div>
...
const breadcrumbIconSlots = computed(() =>
  Object.keys(slots).filter(name => name.startsWith('icon-')),
)
</script>
