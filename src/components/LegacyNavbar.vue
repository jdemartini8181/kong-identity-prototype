      ...
      <div class="navbar-content">
        ...
        <div class="navbar-content-center">
          <div class="phablet-search-container">
            <button class="kong-ui-konnect-ksearch" type="button">
              <div class="search-left">
                <SearchIcon decorative :size="KUI_ICON_SIZE_40" />
                <div class="search-text">Search Konnect</div>
              </div>
        ...
        <div class="navbar-content-right">
          <button class="ask-kai-button" type="button">
            <SparklesIcon decorative :size="KUI_ICON_SIZE_30" />
            <span>Ask KAI</span>
          </button>

          <div class="feedback-dropdown">
            <button class="feedback-dropdown-btn" type="button" aria-label="Feedback">
              <FeedbackIcon decorative />
            </button>
          </div>

          <button class="help-dropdown-btn" type="button" aria-label="Help">
            <HelpIcon decorative />
          </button>

          <button class="notifications-dropdown-trigger" type="button" aria-label="Notifications">
            <NotificationIcon decorative />
          </button>
...
const props = defineProps({
  ...
  leftOffset: { type: Number, default: 240 },
})
